...
describe Account::CharactersController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created character" do
        post :create, :character => valid_attributes
        response.should redirect_to(account_character_url(Character.last))
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "redirects to the character" do
        character = Character.create! valid_attributes
        put :update, :id => character.id, :character => valid_attributes
        response.should redirect_to(account_character_url(character))
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the character as @character" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Character.any_instance.stub(:save).and_return(false)
        put :update, :id => character.id.to_s, :character => {}
        assigns(:character).should eq(character)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested character" do
      character = Character.create! valid_attributes
      expect {
        delete :destroy, :id => character.id.to_s
      }.to change(Character, :count).by(-1)
    end
    ...
    it "redirects to the characters list" do
      character = Character.create! valid_attributes
      delete :destroy, :id => character.id.to_s
      response.should redirect_to(account_characters_url)
    end
  end
